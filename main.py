...
def book_ticket():
    ...
    if answer == 'Yes':
        ...
        book_dict[(rows, columns)] = booking
...
def info(rows, columns):
    class_val = book_dict[(rows, columns)]
    print("\nName:" + class_val.Name)
...
while True:
    ...
    if n == 1:
        ...
        print("Ticket Successfully booked!! Enjoy your movie")
        ...
        print("Wrong option selected, please choose correct option:")